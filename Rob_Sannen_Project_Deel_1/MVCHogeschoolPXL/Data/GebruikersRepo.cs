...
namespace MVCHogeschoolPXL.Data
{
    public class GebruikersRepo
    {
        ...
        public VakLector GetVaklectorById(int id)
        {
            VakLector vl = new VakLector();
            vl = _context.VakLectoren.Where(v => v.Lector.GebruikerId == id).FirstOrDefault();
            return vl;
        }
        ...
        {
            Lector l = new Lector();
            l = _context.Lectoren.Where(v => v.GebruikerId == id).FirstOrDefault();
            return l;
        }

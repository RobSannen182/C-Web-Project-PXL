...
namespace MVCHogeschoolPXL.Controllers
{
    public class GebruikersController : Controller
    {
        ...
        {
            var gebruiker = await _context.Gebruikers.FindAsync(id);
            if (VakLectorExists(id))
            {
                _context.VakLectoren.Remove(_repo.GetVaklectorById(id));
                _context.Lectoren.Remove(_repo.GetLectorById(id));
            }
        ...
        {
            return _context.VakLectoren.Any(e => e.Lector.GebruikerId == id);
        }
    }
}
